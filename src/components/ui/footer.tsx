...
export default function Footer() {
  return (
    <footer className="text-gray-700 py-10 px-4 flex flex-col max-w-7xl mx-auto justify-center items-center">
      ...
      {/* Footer Bottom */}
      <div className="mt-10 pt-6 border-t border-gray-300 text-center text-sm text-gray-500 w-full max-w-xl">
